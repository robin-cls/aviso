...
class CitCICitation(BaseModel):
    cit_identifier: list[CitIdentifier] | CitIdentifier = Field(
        ..., alias='cit:identifier')
...
class MrdMDDigitalTransferOptions(BaseModel):
    mrd_onLine: list[MrdOnLineItem] | MrdOnLineItem = Field(
        ..., alias='mrd:onLine')
...
class MrdMDDistribution(BaseModel):
    mrd_transferOptions: MrdTransferOptions = Field(
